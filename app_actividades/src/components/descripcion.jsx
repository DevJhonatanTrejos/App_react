  ...
  return (
    <div className="Home">
      <div className="nav">
        ...
        <li className="items-nav">
          <button className="button-nav-active">Consultar Descripción</button>
        </li>
        <li className="items-nav">
      ...
      <div>
      <div className="nav-title">--Detalle de actividades por descripción--</div>
      

        <div className="frm-activity">
          <div className="form-group">
                    <label className="txt-lbl">Consultar por Nombre de Actividad</label>
                    <input className="form-input" placeholder='Ingrese el nombre' />
